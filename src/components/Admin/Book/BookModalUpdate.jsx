...
import { callUpdateBook, callCreateBook, callFetchCategory, callUploadBookImg } from '../../../services/api';
import { LoadingOutlined, PlusOutlined } from '@ant-design/icons'
import { v4 as uuidv4 } from 'uuid';

const BookModalUpdate = (props) => {
    const { openBookModalUpdate, setOpenBookModalUpdate, dataUpdate, setDataUpdate } = props;
